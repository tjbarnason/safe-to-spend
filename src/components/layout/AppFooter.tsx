...
export function AppFooter() {
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-50 border-t bg-white/95 backdrop-blur-sm">
      <div className="mx-auto max-w-[420px]">
        <nav className="flex items-center justify-around py-2.5 px-2">
          <Link href="/" className="flex flex-col items-center gap-1 px-4 py-1">
            ...
            <span className="text-[10px] font-semibold text-emerald-600">Home</span>
          </Link>
          <Link href="/position" className="flex flex-col items-center gap-1 px-4 py-1">
            ...
            <span className="text-[10px] font-medium text-slate-400">Insights</span>
          </Link>
          <Link href="/simulate" className="flex flex-col items-center gap-1 px-4 py-1">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 text-slate-400">
              <circle cx="12" cy="12" r="10" />
              <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" />
              <line x1="12" y1="17" x2="12.01" y2="17" />
            </svg>
            <span className="text-[10px] font-medium text-slate-400">What If</span>
          </Link>
          <Link href="#" className="flex flex-col items-center gap-1 px-4 py-1">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-5 w-5 text-slate-400">
